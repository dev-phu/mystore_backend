...
urlpatterns = [
    ...
    path(
        "products/<int:pk>/", ProductDetailView.as_view(), name="product_detail_general"
    ),
    # ========= get my product (seller) ===========
    path(
        "products/mysellerproduct/", SellerProductListView.as_view(), name="my_products"
    ),
    # ========= put/delete my product (seller) ===========
    path(
        "products/mysellerproduct/<int:pk>/",
