...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.RESTRICT) # ป้องกันไม่ให้ลบสินค้าถ้ามีคนสั่งซื้อไปแล้ว
    quantity = models.IntegerField()
    unit_price = models.DecimalField(max_digits=10, decimal_places=2) # เก็บราคา ณ วันที่ซื้อ (เผื่ออนาคตสินค้าปรับราคา)
